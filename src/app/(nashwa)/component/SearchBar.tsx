...
const SearchBar = () => {
  return ( 
    <form className="min-w-90 px-2 flex justify-center items-center rounded-full shadow-sm shadow-[#e4e6e9] border border-[#F0F2F5] bg-[#F0F2F5] focus-within:border-[#BA5B55] focus-within:bg-white focus-within:shadow-none transition-colors duration-300">
      <input
        type="text"
