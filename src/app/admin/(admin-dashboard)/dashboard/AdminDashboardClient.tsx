...
const AdminDashboardClient = ({
  ...
  return (
    <div className="flex flex-col gap-8 min-h-0 text-[#e0e0e0] font-sans">
      {/* Top Summary Stats */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-[#1e1e1e] border border-[#333] p-5 rounded-3xl shadow-sm flex items-center justify-between">
          <div>
        ...
        <div className="bg-[#1e1e1e] border border-[#333] p-5 rounded-3xl shadow-sm flex items-center justify-between">
          ...
          <div className="p-3 bg-[#BA5B55]/10 text-[#BA5B55] rounded-2xl border border-[#BA5B55]/20">
      ...
      {activeTab === "pending" ? (
        pendingRequests.length === 0 ? (
          <div className="flex-1 flex flex-col justify-center items-center border border-dashed border-[#333] rounded-3xl p-12 text-center gap-3 bg-[#161616]/50 my-auto">
